...
\comment{The above Kore language needs to be extended in order to support the following features at least. Most of the features arise in lambda calculus.
\begin{itemize}
	\item Restricted metavariables;
	\item Notations for substitution;
	\item User-defined variable syntaxes;
	\item Defining and using syntactic sugars;
\end{itemize}}
...
\begin{corollary}
	The theory of lambda calculus $\LAMBDA$ is consistent.
\end{corollary}
