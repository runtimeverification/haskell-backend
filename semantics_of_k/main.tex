...
\begin{notation}
	As a convention, we use $b$ as $\KBool$ variables, $x, y, z$ for $\KString$ variables, $s$ for $\KSort$ variables, $\sigma$ for $\KSymbol$ variables, and $p, q, r$ for $\KPattern$ variables. 
\end{notation}
...
otherwise, $\mathit{getSort}$ returns $\Ksort(s)$ if the pattern has sort $s$.
