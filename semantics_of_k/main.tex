...
\begin{grammar}\small	
	...
	<module>       ::= "module" <module-id> <module-body> "endmodule" <attribute> 
	
	<module-body>  ::= <module-sentence>*
	
	<module-sentence> ::= "import" <module-id> <attribute>
	\alt "sort" <sort-id> <attribute>
	\alt "symbol" <symbol-id> "(" <sort-id-list> ")" ":" <sort-id> <attribute>
	\alt "axiom" <pattern> <attribute>
	
	<sort-id-list> ::= $\epsilon$ | <sort-id> <comma-sort-id>*
	
	<comma-sort-id> ::= "," <sort-id>
	
	<sort-id> ::= <sort-regexp> | <sort-id> "{" <sort-variable> "}"
	
	<pattern> ::= <pattern-variable> | "\\and" "(" <pattern> "," <pattern> ")"
	\alt "\\not" "(" <pattern> ")" | "\\exists" "(" <pattern-variable> "," <pattern> ")"
	\alt "\\equals" "(" <pattern> "," <pattern> ")"
	\alt <symbol-id> "(" <pattern-list> ")" | <pattern> ":" <sort-id>
	
	<pattern-list> ::= $\epsilon$ | <pattern> <comma-pattern>*
