...
a set $A$ of axioms, the semantics of built-ins are given
...
An interpreter may use a external library for fast implementation
as oracle, while a symbolic execution engine may use an SMT solver like Z3.
