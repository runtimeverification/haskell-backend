...
A Kore definition is a sequence of \emph{Kore declarations}. Kore declarations can be either one of the follows:
\begin{itemize}\itemsep0em
...
\subsubsection{Object Namespace and Meta-Namespace}
Meta-namespace contains identifiers whose first letter is ``\,\shp\ ''.

\subsubsection{Sort Declaration}
A sort declaration starts with the keyword $\sort$, followed by an identifier and a list of sort parameters wrapped with curly braces.
