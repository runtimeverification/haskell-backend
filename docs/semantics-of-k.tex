...
\begin{remark}
	...
	\begin{center}
		...
		for any $\shp s, \shp s' \in S_K$ are sorts in the meta-theory $K$
	\end{center}
...
\todo[inline]{TODO:: Start revising from here!!}
The predicate symbol $\KinKSortList$ checks list membership given a sort and a 
cons-list of sorts.
It is defined as a symbol schema
$$\parametric{\KinXList}{\shs} \colon 
...
\begin{notation}
	...
	\begin{equation*}
	(x_1, x_2, \dots, x_n) \equiv \KconsXList(x_1, \KconsXList(x_2, 
	\dots\KconsXList(x_n, \KnilXList)\dots))
	\end{equation*}
\end{notation}
