...
Heads include \emph{object-level heads} and \emph{meta-level heads}, that are 
used to construct \syntacc{object-pattern} and \syntacc{meta-pattern} 
respectively, which are treated differently in the \emph{lifting process}.
...
\alt `symbol' <object-head> `(' <object-sort-list> `)' `:' <object-sort>
\alt `symbol' <meta-head> `(' <meta-sort-list> `)' `:' <meta-sort>
\alt `alias' <object-head> `(' <object-sort-list> `)' `:' <object-sort>
\alt `alias' <meta-head> `(' <meta-sort-list> `)' `:' <meta-sort>
