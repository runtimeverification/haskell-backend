...
algorithms and decision procedures for OS have been proposed and implemented in 
languages like Maude, but that in general OS is hard from a theoretical point 
of view and reasoning in an OS setting is even harder.  And that what we'd like 
is to allow backends to make use of decision procedures and algorithms, but at 
the same time to have a crystal clear and easier mathematical foundation for 
OS, via a methodological embedding in ML
