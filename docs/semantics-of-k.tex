...
Lifting will be defined in detail in Section~\ref{sec:reflect}, after we 
...
A summary is provided in Section~\ref{sec:K-summary}.
...
\begin{equation*}
\Ksymbol \colon \KString \times \KSortList\footnote{The sort $\KSortList$ is 
defined in Section~\ref{sec:finite-lists}} \times \KSort \times \KSortList \to 
...
Section~\ref{sec:matching-logic-patterns}.}
in $S_K$,
