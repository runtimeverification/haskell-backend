...
Section~\cref{sec:kore-syntax-pattern}, we would like to 
...
Section~\cref{sec:kore-semantics}.
...
\begin{grammar}\small
	...
	\alt <object-variable-name> `:' <object-sort>
	
	<meta-pattern> ::= \quad
	\alt <meta-head> `(' <pattern-list> `)'
	\alt <meta-variable-name> `:' <meta-sort>
	\alt <string-literal>
