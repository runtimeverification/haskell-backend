...
\begin{center}
	...
	\end{tabular}
\end{center}
What Kore does is to give users a nice way to specify $\denote{T}$, a finite number of symbols and axioms (see Section~\cref{sec:}), while allows users to work with $T$.
In other words, the semantics of Kore is given by lifting itself to the meta-theory.
Kore is a nice interface language to write meta-theory things
