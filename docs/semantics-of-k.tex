...
An identifier is said to be a meta-level one, if it starts with the letter 
``\verb|#|''.
Otherwise, it is said to be an object-level one.
...
\paragraph{Sort Declarations.}
A sort declaration starts with the keyword ``\verb|sort|'', followed by an 
object identifier called an \emph{object sort constructor},  
...
\begin{center}
	{\ttfamily
		\begin{tabular}{lll}
			...
			\parametric{List}{\parametric{List}{Int}} & 
			\parametric{Map}{Int,Int} & 
			\parametric{Map}{Int,\parametric{Map}{Int,Bool}} \\
