...
\begin{center}
	\begin{tabular}{l|l}
		...
		\\\hline
		Sort $\Nat$ & \qquottt{Nat}
		\\\hline
		Parametric sort $\List$ & \qquottt{List}
		\\\hline
		Constant $O$ & \qquottt{zero}
		\\\hline
		Function $S$ & \qquottt{succ}
		\\\hline
		Function $\_+\_$ & \qquottt{plus}
		\\\hline
		Constant $\epsilon$ & \qquottt{nil}
		\\\hline
		Function $::$ & \qquottt{cons}
		\\\hline
	    Function $@$ & \qquottt{append}
	    \\\hline
...
Given the naming function as in Table~\ref{tab:naming}, it is straightforward 
to obtain the meta-representations of sorts in theory $T_L$.
\begin{center}
	\begin{tabular}{l|r}
	...
	$\parametric{\List}{\Nat}$ 
	& 
	$\Ksort(\qquottt{List}, \KconsKSortList(\Ksort(\qquottt{Nat}, 
	\KnilKSortList),\KnilKSortList))$
	\\\hline
	$\parametric{\List}{\parametric{\List}{\Nat}}$
	&
	$\Ksort(\qquottt{List}, \KconsKSortList(\dots,\KnilKSortList))$
	\\\hline
	\dots & \dots
	\end{tabular}
\end{center}
Even though the meta-representations (in the right column) are straightforward 
and easy to construct, they are often too lengthy to fit in one line or even 
one page.
...
exactly this job (in Section~\ref{sec:ML-theories}).
