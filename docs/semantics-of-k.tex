...
\begin{itemize}
\item a nonempty sequence of alphabets and digits and the character 
``\verb|'|'' that starts with an alphabet and is not a \syntacc{keyword};
\item the character ``\verb|#|'' followed by a sequence like the above;
\item the character ``\verb|\|'' followed by a sequence like the above;
\end{itemize}
