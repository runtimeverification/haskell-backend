...
The partial function 
The symbols $\KwellFormed$, $\KgetSort$, and $\KgetSortsFromPatterns$ are axiomatized by the following axioms
\begin{align*}
  ...
  \\
  & \KwellFormed(\overline{\sigma(L)}, \Sigma) = \KsymbolDeclared(\sigma, \Sigma) \wedge (\KgetSortsFromPatterns(L, \Sigma) = \KgetArgumentSorts(\sigma))
  \\
