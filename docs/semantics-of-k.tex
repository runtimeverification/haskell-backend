...
the logic. Some typical example properties of matching logic include the 
...
The sort of $K$ for strings is denoted as $\KString$, which are defined in 
Section~\cref{?}.
...
We adopt the same approach here. We introduce and axiomatize a finite number of
