...
\section{Warming-Up: Meta-Theory and Reflection in Matching Logic}
...
\section{Warming-Up: Notations, Conventions, and Terminologies}

We will define the meta-theory in Section~\ref{sec:meta-theory}.
The meta-theory is a complex theory, and we will use many notations and 
conventions to help us define it.
Most notations and naming conventions are explained when they first appear.
In this section, we will introduce some general notations, methods, and 
techniques that help us specify matching logic theories.

\subsection{Review: Matching Logic Grammar}
...
While in $K$ the number of sorts are designed to be finite (see 
