...
say $\ite\in\Sigma_{\Exp\times\Stmt\times\Stmt,\Stmt}$,
...
Section~\ref{sec:rewriting}, we can state that $\ite$ should evaluate its
first argument with the following axiom:
$$
