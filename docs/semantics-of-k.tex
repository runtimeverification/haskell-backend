...
<declaration> ::= \quad
\alt `sort' `{' <sort-variable-list> `}' <object-sort>
\alt `symbol' `{' <sort-variable-list> `}' <object-head> `(' <object-sort-list> 
`)' `:' <object-sort>
\alt `symbol' `{' <sort-variable-list> `}' <meta-head> `(' <meta-sort-list> `)' 
`:' <meta-sort>
\alt `alias' `{' <sort-variable-list> `}' <object-head> `(' <object-sort-list> 
`)' `:' <object-sort>
\alt `alias' `{' <sort-variable-list> `}' <meta-head> `(' <meta-sort-list> `)' 
`:' <meta-sort>
