...
Here we only consider subsort overloading as ad-hoc overloading can be 
eliminated by renaming of operators.
...
$\parametric{f}{s_1,\dots,s_n}(t_1,\dots,t_n)$ is a well-formed pattern.
