...
\todo[inline]{We need a few words about reflexive logic and logic embeddings before we introduce}
...
$$
\KoccurFree(x, s_1, \varphi) \wedge \KoccurFree(y, s_1, \varphi) \to 
\overline{\exists_{s_1}^{s_2} x .(\varphi[x \cln s_1 / z \cln s_1])} = \overline{\exists_{s_1}^{s_2} y .(\varphi[y \cln s_1 / z \cln s_1])}
$$
