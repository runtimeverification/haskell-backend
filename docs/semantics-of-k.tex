...
\begin{center}
	...
	\end{tabular}
\end{center}
What Kore does is to give users a nice way to specify $\widehat{T}$, a finite number of symbols and axioms (see Section~\cref{sec:}), while allows users to work with $T$.
