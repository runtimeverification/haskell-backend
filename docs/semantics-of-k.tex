...
26 + 10 + 3 = 65$ functional constructors (more can be added if needed or
desired):
\begin{center}
	\begin{tabular}{c c c}
...
the provability relation of finite theories (`` $\vdashfin$ ''), the only ones
...
digits and the character~``\verb|'|'' that starts with a
