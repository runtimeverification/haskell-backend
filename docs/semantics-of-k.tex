...
$$
These helper functions in $\denote{T}$ allows us to write compact 
...
\Kqcons(s,\varphi_1,\varphi_2) = 
   ...
   $\_::_s\_$},\underbrace{(\varphi_1,\varphi_2)}_\text{two patterns}) 
   \right)
$$
...
\parametric{\List}{s}@_s L\cln \parametric{\List}{s})
\end{align*}
for any sort $s,s'$ defined in theory $T_L$.
