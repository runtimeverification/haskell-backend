...
\begin{definition}[Encoding and Lifting]
	...
	\end{itemize}
    Given $e = \{e_S, e_\Sigma \}$ is an encoding of $S$ and $\Sigma$ in $K$, the \emph{lift of the theory $T = (S, \Sigma, A)$ with respect to the encoding $e$} is a family of lifting functions that are defined as follows.
    ...
    Definition (Theory-lifting). Since $T = (S, \Sigma, A)$ is a finite theory, let us suppose
    \begin{equation*}
       S = \{ s_1, \dots, s_n \}, 
