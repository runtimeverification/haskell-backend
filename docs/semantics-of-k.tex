...
the implementation $M$ of $\Sigma$ into an implementation of $\Sigma'$, or
a reuse of a richer implementation in a smaller context.
...
Let $(S_B,\Sigma_B)$ be a subsignature of \emph{built-ins} of $(S,\Sigma)$.
That is, $S_B \subseteq S$ and $\Sigma_B \subseteq \Sigma$.

$\Mod(\Sigma_B,\Sigma) = \{(M_B,M)\ \mid\ M\upharpoonright_{\Sigma_B} = M_B \}$

$\Mod(\Sigma_B,\Sigma,A) =
\denote{(\Sigma_B,\Sigma,A)} =
\{M \ \mid \ M \in \Mod_{\Sigma},\ M \models_{(S,\Sigma)} A \}$
