...
We will do this in Section~\ref{sec:meta-theory}, but for now we will continue
...
relationship between its first argument $x$ and other occurrences of $x$ in
...
apply to predicates and not to terms/patterns.
