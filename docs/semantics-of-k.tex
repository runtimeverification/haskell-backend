...
To help us write compact meta-representations of symbols, we introduce some 
helper functions (one for each symbol) to the meta-theory as follows:
\begin{align*}
  \Kqzero \colon \to \KSymbol \\
  \Kqsucc \colon \to \KSymbol \\
\end{align*}
%
