...
\begin{notation}
	...
	The following notation conventions are adopted to write $\KPattern$ patterns in a more compact way, by putting a bar upon their normal mixfix forms:\info{$\sigma$ is a $\Ksymbol(...)$ thing, isn't it? Xiaohong: Yes, it is. And $\sigma$ is a $\KSymbol$ variable. I will add that to the notation convention. }
	\begin{align*}
