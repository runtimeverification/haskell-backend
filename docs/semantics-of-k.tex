\documentclass[UTF8,11pt]{article}
  ...
  \newcommand{\Kdeduce}{\mathit{\#provable}}
...
\begin{itemize}
	...
	\item $\Kdeduce$ is a symbol in $K$ (see Section~\cref{sec:ML-proof-system})
\end{itemize}
...
Lifting will be defined in detail in Section~\cref{sec:lifting}, but before that we would like to use two examples to illustrate the big picture of how things work and to define a set of terminologies that we will use later.
