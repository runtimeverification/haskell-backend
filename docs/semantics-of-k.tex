...
letter ``\verb|#|''.
Otherwise, it is said to be an \emph{objecty identifier}.

\begin{grammar}\small\centering
	<id>    ::= <meta-id> | <object-id>
\end{grammar}
...
{Reserved Logical Connectives and Derived Connectives.}
\begin{center}
	\begin{tabular}{llll}
...
\subsubsection{Special Characters, Keywords and Namespaces}
The following characters have special meaning in Kore:
\begin{center}
\begin{tabular}{c|l|l}
	\textbf{Character} & \textbf{Name} & \textbf{Usage}
	\\\hline
	\texttt{:} & Colon & Variable constructor and symbol declaration
	\\
	\texttt{\string{ \string}} & Curly braces & Sort parameters
	\\
	\texttt{( )} & Parenthesis & Kore expression
	\\
	\texttt{:=} & Colon equal & Alias definition
\end{tabular}
\end{center}
