...
\begin{center}
	...
	\end{tabular}
\end{center}
where $\denote{T}$ is the meta-theory of $T$, $\denote{\varphi}$ is the 
...
truth in theory $T$. The \emph{lifting} operation ``$\denote{\ \ \ }$'' brings 
...
$T$ could be infinite, its lifting $\denote{T}$ is a finite theory.
