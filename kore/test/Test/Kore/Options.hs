...
test_flags =
    [ testGroup
            ...
            let flagValue =
                    willPrintDefinition $
                        runParser
                            ...
                            ["mock/path/to/def"]
            assertEqual
                "Expected print-definition to be False by default"
                False
                flagValue
        , testCase "given explicitly is True" $ do
            ...
            assertEqual
                "Expected --print-definition to give True"
                True
                flagValue
        , testCase "with `no` prefix is False" $ do
            ...
            assertEqual
                "Expected --no-print-definition to give False"
                False
                flagValue
        ]
    , testGroup
            ...
            let flagValue =
                    willPrintPattern $
                        runParser
                            ...
                            ["mock/path/to/def"]
            assertEqual
                "Expected print-pattern to be False by default"
                False
                flagValue
        , testCase "given explicitly is True" $ do
            let flagValue =
            ...
            assertEqual
                "Expected --print-pattern to give True"
                True
                flagValue
        , testCase "with `no` prefix is False" $ do
            let flagValue =
            ...
            assertEqual
                "Expected --no-print-pattern to give False"
                False
                flagValue
        ]
    ]
...
test_options =
    [ testGroup
        "pattern and module must go together"
