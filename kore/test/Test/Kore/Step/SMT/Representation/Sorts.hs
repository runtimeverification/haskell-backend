...
import qualified Kore.Step.SMT.AST as AST
                 ( Declarations, Encodable (AlreadyEncoded), Sort,
                 SortReference, SymbolReference )
...
import           Test.Kore.Step.SMT.Builders
                 ...
                 koreSort, sortDeclaration, symbolDeclaration )
import           Test.Kore.Step.SMT.Helpers
                 ( constructorAxiom )
import           Test.Kore.Step.SMT.Representation.Builders
                 ( emptyDeclarations, unresolvedConstructorArg,
                 unresolvedDataMap, unresolvedIndirectSortMap,
                 unresolvedSortConstructor, unresolvedSortMap )
import           Test.Kore.Step.SMT.Representation.Helpers
                 ( declarationsAre, smtForSortIs )
