...
nonLinX = mkVar Variable { variableName = testId "x", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
nonLinY = mkVar Variable { variableName = testId "y", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
...
expA = mkVar Variable { variableName = testId "a", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
expX = mkVar Variable { variableName = testId "x", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
expY = mkVar Variable { variableName = testId "y", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }

ex1, ex2, ex3, ex4 :: CommonStepPattern Object
ex1 = mkVar Variable { variableName = testId "ex1", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
ex2 = mkVar Variable { variableName = testId "ex2", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
ex3 = mkVar Variable { variableName = testId "ex3", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
ex4 = mkVar Variable { variableName = testId "ex4", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }
...
x = mkVar Variable { variableName = testId "x", variableCounter = mempty, variableSort = s1, variableType = ElementVariable }

xs2 :: CommonStepPattern Object
xs2 = mkVar Variable { variableName = testId "xs2", variableCounter = mempty, variableSort = s2, variableType = ElementVariable }
