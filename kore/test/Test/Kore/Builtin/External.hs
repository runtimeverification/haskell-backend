  ...
  where
    ...
    externalize1 termLike =
        ...
        case termLikeF of
            ...
            InternalSetF internalSet               -> either externalize1 id $
                externalizeSet internalSet
            InternalMapF internalMap               -> either externalize1 id $
  ...
  where
    ...
    worker concreteElements symbolicElements opaqueTerms =
      ...
      where
        ...
        concat' operand pat = Free $
            (Attribute.Null :<) $ Syntax.ApplicationF
            $ Application (Symbol.toSymbolOrAlias concatSymbol)
                [operand, pat]
...
externalizeBool builtin =
    Attribute.Null :< Syntax.DomainValueF
        DomainValue
