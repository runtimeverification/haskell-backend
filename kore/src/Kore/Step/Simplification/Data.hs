...
class
  (WithLog LogMessage m, MonadSMT m, MonadProfiler m)
  => MonadSimplify m where
...
instance
  (MonadUnliftIO m, WithLog LogMessage m)
...
instance
  (MonadUnliftIO m, MonadSMT m, WithLog LogMessage m, MonadProfiler m)
