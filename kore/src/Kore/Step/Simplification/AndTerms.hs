...
andEqualsFunctions = fmap mapEqualsFunctions
    ...
    , (BothT,   \_ _ s -> Builtin.KEqual.termKEqualsTrue s, "Builtin.KEqual.termKEqualsTrue")
    , (BothT,   \_ _ s -> Builtin.KEqual.termKEqualsFalse s, "Builtin.KEqual.termKEqualsFalse")
