...
instance From (RulePattern variable) (Attribute.Priority, Attribute.Owise, Attribute.Simplification) where
...
instance From (RewriteRule variable) (Attribute.Priority, Attribute.Owise, Attribute.Simplification) where
