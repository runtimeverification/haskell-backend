...
import           Data.Kore.Implicit.ImplicitKoreImpl     (equalsAxiom,
                                                          parameterizedAxiom, parameterizedEqualsAxiom)
...
defineMetaSort sortType =
  ...
  where
    ...
    append = symbol_ ("#append" ++ listSortName) [listSort, listSort] listSort
    ...
    delete = symbol_ ("#delete" ++ listSortName) [objectSort, listSort] listSort
