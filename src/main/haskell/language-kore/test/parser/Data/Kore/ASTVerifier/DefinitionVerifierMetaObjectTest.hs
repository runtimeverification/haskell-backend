...
definitionVerifierMetaObjectTests =
    testGroup
        "Meta-Object pattern interactions."
        [ expectSuccess
              "Object pattern with meta-pattern sort."
        ...
        , expectFailureWithError
              "Object pattern with meta-char sort."
              Error
                  { errorContext =
        ...
        , expectSuccess
              "Meta pattern with meta-pattern sort in object pattern."
              (simpleDefinitionFromSentences
                   (ModuleName "test")
                   [ simpleAxiomSentence
                         (ObjectPattern
