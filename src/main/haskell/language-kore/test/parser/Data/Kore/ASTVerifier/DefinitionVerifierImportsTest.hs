...
definitionVerifierImportsTests =
    testGroup
        ...
        [importTests, nameVisibilityTests, nameDuplicationTests]
...
nameVisibilityTests =
    testGroup
        ...
        (sortVisibilityTests ++ symbolVisibilityTests ++ aliasVisibilityTests)
...
sortVisibilityTests =
    [ nameReferenceTests
          ...
          (ErrorStack
               ["axiom declaration", "\\top", "sort 'sort2'", "sort 'sort1'"])
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Sort 'sort1' not declared.")
          (ErrorStack ["axiom declaration", "\\top", "sort 'sort1'"])
          (DeclaringSentence sortDeclaration)
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Sort 'sort1' not declared.")
          (ErrorStack ["axiom declaration", "\\exists 'var'", "sort 'sort1'"])
          (DeclaringSentence sortDeclaration)
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Sort 'sort1' not declared.")
          (ErrorStack ["axiom declaration", "\\and", "sort 'sort1'"])
          (DeclaringSentence sortDeclaration)
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Sort 'sort1' not declared.")
          (ErrorStack ["symbol 'symbol1' declaration", "sort 'sort1'"])
          (DeclaringSentence sortDeclaration)
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Sort 'sort1' not declared.")
          (ErrorStack ["alias 'alias1' declaration", "sort 'sort1'"])
          (DeclaringSentence sortDeclaration)
    ...
    , nameReferenceTests
          ...
          (SupportingSentences sortReferenceInSentenceAliasSortsSupportSentences)
    , nameReferenceTests
  ...
  where
    ...
    metaTopSortPattern = MetaPattern (TopPattern Top { topSort = charMetaSort })
    sortReferenceInSort =
        SortActualSort SortActual
    ...
    sortReferenceInSentenceAliasSortsSupportSentences = [anotherSortDeclaration]
...
symbolVisibilityTests =
    [ nameReferenceTests
          ...
          (ErrorStack ["axiom declaration", "symbol or alias 'symbol1'"])
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Symbol 'symbol1' not defined.")
          (ErrorStack
               ["axiom declaration", "\\and", "symbol or alias 'symbol1'"])
          (DeclaringSentence symbolDeclaration)
...
aliasVisibilityTests =
    [ nameReferenceTests
          ...
          (ErrorStack ["axiom declaration", "symbol or alias 'alias1'"])
    ...
    , nameReferenceTests
          ...
          (ExpectedErrorMessage "Symbol 'alias1' not defined.")
          (ErrorStack ["axiom declaration", "\\and", "symbol or alias 'alias1'"])
          (DeclaringSentence aliasDeclaration)
  ...
  where
    ...
    aliasReferenceInAliasOrAliasSupportSentences =
        ...
        $ SentenceAliasSentence SentenceAlias
            ...
            , sentenceAliasSorts = [SortVariableSort (SortVariable (Id "sv1"))]
            , sentenceAliasResultSort =
                  SortVariableSort (SortVariable (Id "sv1"))
            , sentenceAliasAttributes = Attributes []
            }
...
nameReferenceSuccessTests
    :: DeclaringSentence -> UsingSentence -> SupportingSentences -> [TestTree]
nameReferenceSuccessTests
          ...
          Definition
              ...
              , definitionModules =
                    [ Module
                          { moduleName = ModuleName "M1"
                          , moduleSentences =
                                usingSentence : supportingSentences
                          , moduleAttributes = Attributes []
                          }
                    ]
              }
