...
definitionVerifierUniqueNamesTests =
    testGroup
        ...
        , expectSuccess
              "Definition with two meta aliases"
              (simpleDefinitionFromSentences
                   (ModuleName "MODULE")
        ...
        , expectSuccess
              "Definition with two object aliases"
              (simpleDefinitionFromSentences
                   (ModuleName "MODULE")
        ...
        , expectSuccess
              "Definition with two meta symbols"
              (simpleDefinitionFromSentences
                   (ModuleName "MODULE")
                   [ simpleMetaAliasSentence (AliasName "#a1") stringSortName
                   , simpleMetaAliasSentence (AliasName "#a2") stringSortName
        ...
        , expectSuccess
              "Definition with two object symbols"
              (simpleDefinitionFromSentences
                   (ModuleName "MODULE")
        ...
        , expectSuccess
              "Sort Parameter Name Same as Variable Name"
        ...
        , expectFailureWithError
              "Definition with two identical sort names."
