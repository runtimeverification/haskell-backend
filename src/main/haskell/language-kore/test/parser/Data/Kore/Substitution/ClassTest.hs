...
testSubstitute
    :: UnifiedPattern -> UnifiedPatternSubstitution -> IntCounter UnifiedPattern
...
substitutionClassTests =
    testGroup
        ...
        [ testCase
              "Testing substituting a variable."
              (assertEqual
                   ""
                   (objectTopPattern, 2)
                   (runIntCounter
                        ...
                        2))
        , testCase
              "Testing not substituting a variable."
              (assertEqual
                   ""
                   ...
                   (runIntCounter
                        ...
                        2))
        , testCase
              "Testing not substituting anything."
              (assertEqual
                   ""
                   ...
                   (runIntCounter
                        ...
                        2))
        , testCase
              "Testing exists => empty substitution."
              (assertEqual
                   ""
        ...
        , testCase
              ...
              (assertEqual
                   ...
                   (runIntCounter
                        (testSubstitute
                             forallObjectUnifiedPattern1
                             substitution1)
                        2))
        , testCase
              "Testing binder renaming"
              (assertEqual
                   ""
                   ...
                   (runIntCounter
                        ...
                        2))
        , testCase
              "Testing binder renaming and substitution"
              (assertEqual
                   ""
                   ...
                   (runIntCounter
                        ...
                        5))
        , testCase
              "Testing double binder renaming"
              (assertEqual
                   ""
                   (forallExistsObjectUnifiedPattern1S2, 9)
                   (runIntCounter
                        (testSubstitute
                             forallExistsObjectUnifiedPattern1
                             substitution2)
                        7))
        , testCase
              "Testing double binder renaming 1"
              (assertEqual
                   ""
                   (forallExistsObjectUnifiedPattern2, 17)
                   (runIntCounter
                        (testSubstitute
                             forallExistsObjectUnifiedPattern2
                             substitution1)
                        17))
        , testCase
              "Testing substitution state 1"
              (assertEqual
                   ""
...
substitution1 = S.fromList [(unifiedObjectVariable, objectTopPattern)]

substitution2 :: UnifiedPatternSubstitution
substitution2 = S.fromList [(unifiedMetaVariable, objectVariableUnifiedPattern)]

substitution3 :: UnifiedPatternSubstitution
substitution3 = S.fromList [(unifiedObjectVariable, metaVariableUnifiedPattern)]
...
existsObjectUnifiedPattern1S n =
    ObjectPattern
    $ ExistsPattern Exists
        { existsSort = objectSort
...
forallExistsObjectUnifiedPattern1S2 =
    ObjectPattern
    $ ForallPattern Forall
        { forallSort = objectSort
