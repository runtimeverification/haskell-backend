...
module Data.Kore.Step.Function.UserDefinedTest (userDefinedFunctionTests) where
...
import           Data.Kore.Step.Condition.Mocks        (mockConditionEvaluator)
...
userDefinedFunctionTests :: TestTree
