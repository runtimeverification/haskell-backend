...
liftTests =
    testGroup
        ...
        [ testLiftUnlift
              ...
              (Id "object" :: Id Object)
        , testLiftUnlift "Meta Pattern" metaStringPattern unifiedStringPattern
        , testLiftUnlift
              "Bottom"
              (Fix (apply
                        (metaMLPatternHead BottomPatternType)
                        [variablePattern "#a" sortMetaSort]))
              (ObjectPattern
                   (BottomPattern Bottom
                        { bottomSort = SortVariableSort (SortVariable (Id "a"))
                        }) :: UnifiedPattern)
        , testLiftUnlift
              "Top"
              (Fix (apply
                        (metaMLPatternHead TopPatternType)
                        [variablePattern "#a" sortMetaSort]))
              (ObjectPattern
                   (TopPattern Top
                        { topSort = SortVariableSort (SortVariable (Id "a"))
                        }) :: UnifiedPattern)
        , testLiftUnlift
              "Ceil"
              (Fix (apply
                        (metaMLPatternHead CeilPatternType)
        ...
        , testLiftUnlift
              "Floor"
              (Fix (apply
                        (metaMLPatternHead FloorPatternType)
                        [ variablePattern "#b" sortMetaSort
                        , variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              "Equals"
              (Fix (apply
                        (metaMLPatternHead EqualsPatternType)
                        [ variablePattern "#b" sortMetaSort
                        , variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
        ...
        , testLiftUnlift
              "In"
              (Fix (apply
                        (metaMLPatternHead InPatternType)
                        [ variablePattern "#b" sortMetaSort
                        , variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
        ...
        , testLiftUnlift
              "Forall"
              (Fix (apply
                        (metaMLPatternHead ForallPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , Fix (apply
                                   variableHead
                                   [ Fix (StringLiteralPattern
                                              (StringLiteral "x"))
                                   , variablePattern "#a" sortMetaSort
                                   ])
                        , Fix (apply
              ...
              (ObjectPattern
                   (ForallPattern Forall
                        { forallSort = SortVariableSort (SortVariable (Id "a"))
                        , forallVariable =
                              Variable
                                  { variableName = Id "x"
                                  , variableSort =
        ...
        , testLiftUnlift
              "Exists"
              (Fix (apply
                        (metaMLPatternHead ExistsPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , Fix (apply
                                   variableHead
                                   [ Fix (StringLiteralPattern
              ...
              (ObjectPattern
                   (ExistsPattern Exists
                        { existsSort = SortVariableSort (SortVariable (Id "a"))
                        , existsVariable =
                              Variable
                                  { variableName = Id "x"
                                  , variableSort =
        ...
        , testLiftUnlift
              ...
              (Fix (apply
                        consPatternListHead
                        [metaStringPattern, Fix (apply nilPatternListHead [])]))
              [metaStringPattern]
        , testLiftUnlift
              "A Variable"
              (Fix (apply
              ...
              Variable
                  ...
                  , variableSort = SortVariableSort (SortVariable (Id "v"))
                  }
        , testLiftUnlift
              "A pure object pattern."
              (Fix (apply
                        (metaMLPatternHead NotPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , Fix (apply
                                   (metaMLPatternHead TopPatternType)
                                   [variablePattern "#a" sortMetaSort])
        ...
        , testLiftUnlift
              "And pattern"
              (Fix (apply
                        (metaMLPatternHead AndPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              "Or pattern"
              (Fix (apply
                        (metaMLPatternHead OrPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              "Iff pattern"
              (Fix (apply
                        (metaMLPatternHead IffPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              "Implies pattern"
              (Fix (apply
                        (metaMLPatternHead ImpliesPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              ...
              (Fix (apply
                        (metaMLPatternHead NotPatternType)
                        [variablePattern "#a" sortMetaSort, metaStringPattern]))
              (ObjectPattern
                   (NotPattern Not
                        { notSort = SortVariableSort (SortVariable (Id "a"))
        ...
        , testLiftUnlift
              "Rewrites pattern"
              (Fix (apply
                        (metaMLPatternHead RewritesPatternType)
                        [ variablePattern "#a" sortMetaSort
                        , metaStringPattern
                        , metaStringPattern
                        ]))
        ...
        , testLiftUnlift
              "Domain Value"
              (Fix (apply
                        (metaMLPatternHead DomainValuePatternType)
                        [variablePattern "#Int" sortMetaSort, metaStringPattern]))
              (ObjectPattern
                   (DomainValuePattern DomainValue
                        { domainValueSort =
                              SortVariableSort (SortVariable (Id "Int"))
                        , domainValueChild = unifiedStringPattern
                        }))
        , testLiftUnlift
              "Application"
              (Fix (apply
        ...
        , testLiftUnlift
              "Next"
              (Fix (apply
                        (metaMLPatternHead NextPatternType)
                        [variablePattern "#a" sortMetaSort, metaStringPattern]))
              (ObjectPattern
                   (NextPattern Next
                        { nextSort = SortVariableSort (SortVariable (Id "a"))
        ...
        , testCase
              "Lift Object Alias Declaration"
              (prettyAssertEqual
                   ""
                   [ SentenceSymbolSentence
                         (symbol_ "#`alias" [] patternMetaSort)
                   ]
                   (liftSentence
                        ( ObjectSentence
                        $ SentenceAliasSentence SentenceAlias
        ...
        , testCase
              "Lift Object Symbol Declaration"
              (prettyAssertEqual
                   ""
                   [ SentenceSymbolSentence
                         (symbol_
        ...
        , testCase
              "Lift Axiom topped in Object Pattern"
              (prettyAssertEqual
                   ""
                   [ SentenceAxiomSentence SentenceAxiom
                   ...
                   (liftSentence
                        ...
                        $ SentenceAxiomSentence SentenceAxiom
                            ...
                            , sentenceAxiomPattern =
                                  ObjectPattern
                                      (TopPattern
                                           (Top (SortVariableSort
                                                     (SortVariable (Id "a")))))
                            , sentenceAxiomAttributes = Attributes []
                            }
                        )))
        , testCase
              "Lift Axiom topped in Meta Pattern"
              (prettyAssertEqual
                   ""
                   [ SentenceAxiomSentence SentenceAxiom
                         { sentenceAxiomParameters = []
...
testLiftUnlift message metaPattern mixed =
    testGroup
        ...
        , testCase
              "Unlifting"
              (prettyAssertEqual "" (Just mixed) (unliftFromMeta metaPattern))
        ]
