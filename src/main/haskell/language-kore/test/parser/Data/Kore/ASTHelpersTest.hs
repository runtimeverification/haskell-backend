module Data.Kore.ASTHelpersTest
    ( astHelperTests
    ) where
...
astHelperTests = testGroup "Ast Helpers Tests" [symbolOrAliasSortsTests]
...
sortVariable name = SortVariable { getSortVariable = Id name }
