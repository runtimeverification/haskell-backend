module Data.Kore.Unparser.UnparseTest
    ( unparseParseTests
    , unparseUnitTests
    ) where
...
unparseParseTests =
    testGroup
        ...
        , testProperty
              ...
              (forAll
                   (symbolGen Object)
                   (unparseParseProp (symbolParser Object)))
        , testProperty
              "Meta Symbol"
        ...
        , testProperty
              "Object SortVariable"
              (forAll
                   (sortVariableGen Object)
                   (unparseParseProp (sortVariableParser Object)))
        , testProperty
              "Meta SortVariable"
              (forAll
                   (sortVariableGen Meta)
                   (unparseParseProp (sortVariableParser Meta)))
        , testProperty
              "Object Sort"
              (forAll (sortGen Object) (unparseParseProp (sortParser Object)))
        , testProperty
              "Meta Sort"
              (forAll (sortGen Meta) (unparseParseProp (sortParser Meta)))
        , testProperty
              "UnifiedVariable"
              (forAll
                   unifiedVariableGen
...
parse parser = parseOnly (parser <* endOfInput) "<test-string>"
...
unparseTest astInput expected =
    testCase
        "Unparsing"
        (assertEqual
             ("Expecting unparse success!" ++ show astInput)
             expected
