...
testPatternUnifiedPattern TestPattern {testPatternPattern = p} =
    asUnifiedPattern p
...
definitionVerifierPatternVerifierTests =
    testGroup
        ...
        , failureTestsForObjectPattern
              ...
              (ErrorStack
                   ["\\exists 'ObjectVariable'", "variable 'ObjectVariable'"])
              (ExistsPattern Exists
        ...
        , failureTestsForObjectPattern
              ...
              (ErrorStack
                   ["\\exists 'ObjectVariable'", "\\exists 'ObjectVariable'"])
              (ExistsPattern Exists
                   { existsSort = objectSort
                   , existsVariable = objectVariable
                   , existsChild =
        ...
        , failureTestsForMetaPattern
              "Meta pattern - sort not defined"
              (ExpectedErrorMessage "Sort '#InvalidMetaSort' not declared.")
              (ErrorStack
                   ["\\exists '#MetaVariable'", "sort '#InvalidMetaSort'"])
        ...
        , failureTestsForObjectPattern
              ...
              NeedsInternalDefinitions
        , failureTestsForMetaPattern
              "Meta pattern - sort not matched"
              (ExpectedErrorMessage
                   "Expecting sort '#Variable{}' but got '#CharList{}'.")
              (ErrorStack
                   ["\\exists '#MetaVariable'", "variable '#MetaVariable'"])
        ...
        , failureTestsForObjectPattern
              ...
              NeedsInternalDefinitions
        , failureTestsForMetaPattern
              "Meta pattern - wrong argument count"
              (ExpectedErrorMessage "Expected 1 operands, but got 0.")
        ...
        , successTestsForObjectPattern
              ...
              NeedsInternalDefinitions
        , successTestsForMetaPattern
              "Meta pattern - unquantified variable"
        ...
        , successTestsForMetaPattern
            ...
            -- at least in some cases.
              NeedsInternalDefinitions
        , failureTestsForMetaPattern
              "String pattern - sort not matched"
              (ExpectedErrorMessage
  ...
  where
    ...
    metaSymbolSentence =
        symbolSentenceWithArguments metaSymbolName metaSort1 [anotherMetaSort2]
...
successTestsForObjectPattern
  ...
  where
    (dummyVariable, dummySortSentences) = dummyVariableAndSentences namePrefix
    testData =
...
failureTestsForObjectPattern
    ...
    patternRestrict
  =
    failureTestDataGroup description errorMessage errorStackSuffix testData
  where
  ...
  where
    contextExpansion =
        testsForUnifiedPatternInTopLevelContext
            ...
            sortVariables
            objectSortVariables
            (symbolSentence : aliasSentence : sentences)
            patternRestrict
    rawSymbolName = namePrefix ++ "_anotherSymbol"
    rawAliasName = namePrefix ++ "_anotherAlias"
            ...
            SentenceSymbol
                { sentenceSymbolSymbol =
                      Symbol
                          ...
                          , symbolParams =
                                [SortVariable (Id rawSortVariableName)]
                          }
...
patternInUnquantifiedObjectPatterns
    ...
    -> [TestPattern Object]
patternInUnquantifiedObjectPatterns
    testedPattern anotherPattern (OperandSort testedSort)
  =
    [ TestPattern
          { testPatternPattern =
                NextPattern Next
