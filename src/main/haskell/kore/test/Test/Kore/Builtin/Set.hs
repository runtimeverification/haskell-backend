...
prop_getUnit k =
    let patIn = App_ symbolIn [ Test.Int.asPattern k, App_ symbolUnit [] ]
        ...
        predicate = give testSymSorts $ mkEquals patFalse patIn
    in
        allProperties
...
prop_inElement value =
    let patIn = App_ symbolIn [ patValue , patElement ]
        ...
        predicate = give testSymSorts $ mkEquals patIn patTrue
    in
        allProperties
...
prop_inConcat elem' values =
    let patIn = App_ symbolIn [ patElem , patSet ]
        ...
        patTrue = Test.Bool.asPattern True
        predicate = give testSymSorts $ mkEquals patTrue patIn
    in
        allProperties
            [ Test.Bool.asExpandedPattern True === evaluate patIn
            , ExpandedPattern.top === evaluate predicate
...
prop_concatUnit values =
    let patUnit = App_ symbolUnit []
        ...
        predicate1 = give testSymSorts $ mkEquals patValues patConcat1
        predicate2 = give testSymSorts $ mkEquals patValues patConcat2
    in
        allProperties
...
prop_difference set1 set2 =
    let patSet1 = asPattern set1
        ...
        predicate = give testSymSorts (mkEquals patSet3 patDifference)
    in
        allProperties
